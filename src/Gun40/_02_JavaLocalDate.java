...
public class _02_JavaLocalDate {
    public static void main(String[] args) {
        ...
        System.out.println("******  başka bir dilde formatta gösterimi  ********");
        // lokalden aldığım tarihi başka bir dilde formatta gösterimi
        System.out.println("Almanca Tarih=" + tarih.format(oz6.withLocale(Locale.GERMANY)) );

        // Lokalizasyon tanımlaması ne demek
        // en- US // Ameika'nın ingilizce konuşulan bölgesi
        // en- UK // İngşltere'nin ingilizce konuşulan bölgesi
        // fr- CA // Kanada'nın fransızca konuşulan bölgesi
        // en- CA // Kanada'nın ingilizce konuşulan bölgesi
       ...
       System.out.println( "Türkçe Tarih= " + tarih.format(oz6.withLocale(lTurkiye)) );
        ...
        System.out.println("\n*******************");
       // Tarih= 2053-05-20; gibi kendimiz bir tarihi nasıl set ederiz
